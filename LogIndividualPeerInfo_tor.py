...
outputFilesToTransferPath = '/media/sf_Shared_Folder/Official_Research_Logs_Tor'
...
def startBitcoin():
	...
	while rpcReady is False:
		if not bitcoinUp():
			subprocess.Popen(['gnome-terminal -t "Bitcoin Core Instance" -- bash ./run_tor_only.sh noconsole'], shell=True)
			time.sleep(5)
